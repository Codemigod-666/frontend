...
export default function Home() {
  ...
  const handleTabing = (tabId) => {
     const newTabing = tabing.map ((tab , id) => (id === tabId? 'true' : 'false'));
                      ...
                      <div className="card-item">
                        <div className="row">
                          <div className="col-xl-5">
                            <div className="card-bg" style={{width:"100%", height:'100%', backgroundImage:`url(${item.img.src})`, backgroundSize:"cover"}}></div>
                          </div>
