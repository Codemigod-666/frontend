...
import foot from '../../public/assets/img/footer-bg.jpg';
...
const Footer = () => {
  ...
  return (
    <div id="footer" className="footer" style={divStyle}>
        ...
        <div className="container">
            ...
            Designed by <a href="https://in.linkedin.com/in/rishi-vijay-khandagle-65306221b?trk=public_post_feed-actor-image">Rishi Khandagle</a>
            </div>
        </div>
        </div>
